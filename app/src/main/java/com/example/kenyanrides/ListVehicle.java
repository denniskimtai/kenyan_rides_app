...
public class ListVehicle {
    ...
    public ListVehicle(String image, String carName, int carPrice, int id, String vehicleBrand, String vehicleOverview, String poweredBy, String location, String modelYear,
