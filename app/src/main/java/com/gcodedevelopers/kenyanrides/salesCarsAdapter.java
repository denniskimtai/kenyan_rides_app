...
public class salesCarsAdapter extends RecyclerView.Adapter<salesCarsAdapter.MyViewHolder>{

    public Context mContext;
    private List<SalesCar> carsList;
    ...
    public salesCarsAdapter(Context mContext, List<SalesCar> carsList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final SalesCar car = carsList.get(position);
    ...
    public void filteredList(ArrayList<SalesCar> filteredList){
